...
<div class="inner-block">
    <div class="inbox">
    	  <h2 dir="rtl" lang="ar">جدول تقييم  الطلاب </h2>
  ...
  <tr>
      <th>  
      <input  dir="rtl" lang="ar" type="text"  value=" التقييم   " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '  التقييم ';}">
       </th>
       <th>  
       <input  dir="rtl" lang="ar" type="text"  value=" التقييم   " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '  التقييم ';}">
       </th>
       <th>  
       <input  dir="rtl" lang="ar" type="text"  value=" التقييم   " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '  التقييم ';}">       </th>
       <th>  
       <input  dir="rtl" lang="ar" type="text"  value=" التقييم   " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '  التقييم ';}">       </th>
       <th>  
       <input  dir="rtl" lang="ar" type="text"  value=" التقييم   " onfocus="this.value = '';" onblur="if (this.value == '') {this.value = '  التقييم ';}">       </th>
